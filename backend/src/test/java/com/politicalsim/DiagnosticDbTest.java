...
class DiagnosticDbTest {
    ...
    void printLastGameSessionDetails() {
        ...
        System.out.println("Found " + sessions.size() + " total sessions. Printing top " + count + " most recent:");
        for (int i = 0; i < count; i++) {
            ...
            System.out.println("CreatedAt: " + (session.getCreatedAt() != null ? session.getCreatedAt() : "N/A"));
            ...
            if (session.getLastRoundSubmissions() != null) {
                for (RoundSubmission sub : session.getLastRoundSubmissions()) {
                    ...
                    if (sub.getAiIntent() != null) {
                        System.out.println("    AI Intent: " + sub.getAiIntent());
                    }
                    if (sub.getAiDecisionBasis() != null) {
                        System.out.println("    AI Decision Basis: " + sub.getAiDecisionBasis());
                    }
                }
            }
