...
def main():
    ...
    parser.add_argument("--scenario-key", default="west_bengal_2000")
    parser.add_argument("--cards-file", default="review/west_bengal_2000_cards_review.json")
    parser.add_argument("--news-file", default="review/west_bengal_2001_2004_new_60_news.json")
    ...
    deleted_cards, created_cards = replace_collection(
        args.api_base_url,
        "/api/admin/cards",
        args.scenario_key,
        cards_data["cards"],
    ...
    print(f"Cards: deleted {deleted_cards}, inserted {created_cards}")
